...
var createRouterReducer = function createRouterReducer(_ref) {
  var _ref$oldLocationChang = _ref.oldLocationChangePayload,
      oldLocationChangePayload = _ref$oldLocationChang === void 0 ? false : _ref$oldLocationChang,
    ...
    if (type === LOCATION_CHANGE) {
      if (oldLocationChangePayload) {
        var _ref3 = payload || {},
            ...
            _location = _objectWithoutProperties(_ref3, ["action"]);
...
var createReduxHistoryContext = function createReduxHistoryContext(_ref) {
  var history = _ref.history,
      ...
      _ref$oldLocationChang = _ref.oldLocationChangePayload,
      oldLocationChangePayload = _ref$oldLocationChang === void 0 ? false : _ref$oldLocationChang,
  ...
  var routerReducer = createRouterReducer({
    oldLocationChangePayload: oldLocationChangePayload,
...
export { CALL_HISTORY_METHOD, LOCATION_CHANGE, createReduxHistoryContext, go, goBack, goForward, push, reachify, replace };
